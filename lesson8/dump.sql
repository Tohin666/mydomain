...
-- Дамп структуры для таблица myShopDB.orders
...
-- Дамп данных таблицы myShopDB.orders: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `orders` DISABLE KEYS */;
/*!40000 ALTER TABLE `orders` ENABLE KEYS */;

-- Дамп структуры для таблица myShopDB.order_list
...
-- Дамп данных таблицы myShopDB.order_list: ~0 rows (приблизительно)
...
-- Дамп данных таблицы myShopDB.users: ~3 rows (приблизительно)
